...
- **Charcos de lluvia**: cuando llueve se forman **unos pocos charcos pequeños** (no inundan ni se extienden) que **se evaporan con el tiempo**. Además, si una zona se anega, el agua poco profunda **se va secando poco a poco** hasta vaciarse (el agua nunca atraviesa paredes ni suelos).
